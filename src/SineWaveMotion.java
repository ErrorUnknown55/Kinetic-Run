...
public class SineWaveMotion implements Motion {
	...
	private double amplitudeFactor = 90;	// increase value to increase amplitude (increase height of curve)
	...
	public void setAmplitudeFactor(int amount){
		this.amplitudeFactor=amount;
	}

	public void setFrequencyFactor(double amount){
		this.frequencyFactor = amount;
	}
	...
	public int getY(){
   	...
   	public void update () {  
		...
		//	  x = 0;
      		...
      		if (radians > (10 * Math.PI)) {		// only run for about three cycles then start over
	   		x = 0;
          		radians = 0.0;
      		}

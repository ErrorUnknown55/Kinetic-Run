...
*/
    ...
    public void loadTileImages() {
        ...
        String basePath = "images/platform/greentiles/"; 
    
        int tileNumber = 1;
        while (true) {
            String filename = basePath + "tileGreen_" + String.format("%02d", tileNumber) + ".png";
            File file = new File(filename);
            
            if (!file.exists()) {
                System.out.println("No more tile images found: " + filename);
                break;
            }
            
            
            System.out.println("Loading tile image: " + filename);
